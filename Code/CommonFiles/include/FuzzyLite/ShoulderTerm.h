...
namespace fl {
    ...
    public:
        ShoulderTerm();
        ShoulderTerm(const std::string& name, flScalar minimum = -(log (0.0)),
                flScalar maximum = (log (0.0)), bool left = true);
        ShoulderTerm(const FuzzyOperator& fuzzy_op, const std::string& name,
                flScalar minimum = -(log (0.0)), flScalar maximum = (log (0.0)), bool left = true);
    ...
    public:
        RightShoulderTerm();
        RightShoulderTerm(const std::string& name, flScalar minimum = -(log (0.0)),
                flScalar maximum = (log (0.0)));
        RightShoulderTerm(const FuzzyOperator& fuzzy_op, const std::string& name,
                flScalar minimum = -(log (0.0)), flScalar maximum = (log (0.0)));
    ...
    public:
        LeftShoulderTerm();
        LeftShoulderTerm(const std::string& name, flScalar minimum = -(log (0.0)),
                flScalar maximum = (log (0.0)));
